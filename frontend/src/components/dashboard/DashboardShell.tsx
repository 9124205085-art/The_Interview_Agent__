...
export function DashboardShell({
  ...
  const moduleSectionRef = useRef<HTMLElement>(null);
            ...
            <>
              ...
              {selectedModule ? (
                <section
                  ...
                  className="mt-10 scroll-mt-6 rounded-xl border border-indigo-100 bg-white p-6 shadow-sm"
                >
                  <div className="mb-4 flex flex-wrap items-center justify-between gap-2 border-b border-slate-100 pb-4">
                    <p className="text-sm text-slate-500">
                      Module selected from the sidebar
                    </p>
                    <button
                      type="button"
                      onClick={() => setSelectedModuleN(null)}
                ...
                <p className="mt-10 rounded-xl border border-dashed border-slate-300 bg-slate-50 px-5 py-4 text-sm text-slate-600">
                  Select a <span className="font-medium">module</span> on the
                  left to see daily tasks and completion status below.
                </p>
              )}
            </>
          ) : (
